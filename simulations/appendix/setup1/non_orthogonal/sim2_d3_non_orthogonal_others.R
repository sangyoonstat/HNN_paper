...
seednum <- 2021 ; num_sim <- 130 ; jive_orth <- F ; setting <- 2
...
if(setting==2){
  ...
  r0 <- 1 ; r12 <- 2 ; r13 <- 3 ; r23 <- 4 ; r1 <- 2 ; r2 <- 3 ; r3 <- 4 ; snr <- 2.0
} 
...
save(hnn_res_array, chosen_1se_vec, chosen_best_vec, chosen_min_vec, file = paste("./sim", sep = "", setting, "_d3_non_orthogonal_others.RData"))
