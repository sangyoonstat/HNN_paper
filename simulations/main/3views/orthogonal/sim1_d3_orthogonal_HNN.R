...
seednum <- 2021 ; num_sim <- 130 ; setting <- 1
...
save(hnn_res_array, chosen_1se_vec, chosen_best_vec, chosen_min_vec, file = paste("./sim", sep = "", setting, "_d3_orthogonal_HNN.RData"))
